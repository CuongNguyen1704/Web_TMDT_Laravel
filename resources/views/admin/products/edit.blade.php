        ...
        <form action="{{ route('admin.products.update',$product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    ...
                    @if ($product->hinh_anh)
                        <img src=" {{ asset('storage/' . $product->hinh_anh) }} " width="100px" alt="">
                    @endif
                </div>
            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="trang_thai" class="form-select">
                        <option value="1" {{ $product->trang_thai == 1 ? 'selected' : '' }}>Hoạt động</option>
                        <option value="0" {{ $product->trang_thai == 0 ? 'selected' : '' }}>Ngừng kinh doanh</option>
                    </select>
                </div>
                <div class="col-md-6">
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-primary px-4">Cập nh sản phẩm</button>
            </div>
        </form>
    </div>
</div>
